...
<table width="955" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
        ...
        <td colspan="3" align="center" valign="top" bgcolor="#201584" class="convnios txt2">envios a domicilio sin cargo</td>
        <td colspan="4" valign="top" bgcolor="#201584" class="convnios txt3">tarjetas 6 cuotas sin interes</td>
  </tr>
  <tr>
...
<?php
	...
	<?php } 
        if( $conteo < 3 ) {
            ...
            for( $i=0; $i<$faltan; $i++ ) {
                ?>
                <td width="49" valign="top"  bgcolor="#201584"></td>
                <td width="210" valign="top" bgcolor="#201584" class="promociones">
                    <span class="tit_promociones"></span>
                    <br />
                    <br />
		</td>
                <?php
