...
<body onload="MM_preloadImages('img/bt_barra_hover.jpg')">
	<div id="container">
		<div id="header">
  				...
  				<tr>
	    			<td height="47" valign="top">
	    				<?php echo $this->Html->link( $this->Html->image( "bt_sospintor.jpg", array( 'alt' => "sos pintor", 'name' => "Image13", 'width' => 105, 'height' => 47, 'border' => 0, 'id' => "Image13" ) ),
	    											  ...
	    											  array( 'escape' => false, "onmouseout" => "MM_swapImgRestore()", "onmouseover" => "MM_swapImage('Image13','','img/bt_barra_hover.jpg',1)" ) ); ?>
	    			</td>
  				</tr>
  			    <tr>
