        ...
        <tr>
            ...
            <td><?php
                if ($obra['Obra']['publicado']) {
                    echo $this->Html->link($this->Html->image('test-pass-icon.png', array('alt' => 'Deshabilitar')), array('action' => 'despublicar', $obra['Obra']['id_obra']), array('escape' => false));
                } else {
                    echo $this->Html->link($this->Html->image('test-fail-icon.png', array('alt' => 'Habilitar')), array('action' => 'publicar', $obra['Obra']['id_obra']), array('escape' => false));
                }
                ?>
            </td>
