        ...
        <tr>
            ...
            <td><?php
                if ($pintor['Pintor']['habilitado']) {
                    echo $this->Html->link($this->Html->image('test-pass-icon.png', array('alt' => 'Deshabilitar')), array('action' => 'deshabilitar', $pintor['Pintor']['id_pintor']), array('escape' => false));
                } else {
                    echo $this->Html->link($this->Html->image('test-fail-icon.png', array('alt' => 'Habilitar')), array('action' => 'habilitar', $pintor['Pintor']['id_pintor']), array('escape' => false));
                }
                ?>
            </td>
            ...
            <td class="actions">
    <?php
    echo $this->Html->link('Ver en sitio', array('administracion' => false, 'action' => 'view', $pintor['Pintor']['id_pintor']), array('target' => '_blank'));
